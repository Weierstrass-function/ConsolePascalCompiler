...
//                 if (currentSymbol != LexicalAnalyzer.eql)
//                 {
...
//                 {
//                     currentSymbol = lexer.NextSym();
//                     if (currentSymbol != LexicalAnalyzer.lbrack)
//                     {
...
//                     if (currentSymbol != LexicalAnalyzer.rbrack)
//                     {
...
//                     while (currentSymbol == LexicalAnalyzer.lbrack || currentSymbol == LexicalAnalyzer.period)
//                     {
//                         if (currentSymbol == LexicalAnalyzer.lbrack)
//                         {
//                             currentSymbol = lexer.NextSym();
